    ...
    if ($config_file) {
        ...
        if ($query) {
           ...
           $query_one .= mysqli_query($con, "INSERT INTO `Wo_Users` (
            ...
            VALUES ('" . mysqli_real_escape_string($con, $_POST['admin_username']). "', '" . mysqli_real_escape_string($con, md5($_POST['admin_password'])) . "','" . mysqli_real_escape_string($con, $_POST['siteEmail']) . "'
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../themes/wowonder/stylesheet/font-awesome-4.5.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="../themes/wowonder/stylesheet/bootstrap.min.css">
        <link rel="stylesheet" href="../themes/wowonder/stylesheet/style.css">
        <script type="text/javascript" src="../themes/wowonder/javascript/jquery-1.11.3.js"></script>
        <script type="text/javascript" src="../themes/wowonder/javascript/init.js"></script>
        <script type="text/javascript" src="../themes/wowonder/javascript/jquery.form.min.js"></script>
    </head>
    <body>
        <?php 
            $page = 'terms';
...
?>
    ...
    <tbody>
      ...
      <tr>
        <td>exif_read_data</td>
        <td>Required exif_read_data</td>
        <td><?php echo ($exif_read_data == true) ? '<font color="green"><i class="fa fa-check fa-fw"></i> Enabled</font>' : '<font color="red"><i class="fa fa-times fa-fw"></i> Disabled</font>'?></td>
      </tr>
      <tr>
        <td>.htaccess</td>
      ...
      <tr>
        ...
        <td><?php echo ($is_writable == true) ? '<font color="green"><i class="fa fa-check fa-fw"></i> Writable</font>' : '<font color="red"><i class="fa fa-times fa-fw"></i> Not writable</font>'?></td>
                                ...
                                <div class="req">
                                    <h5>WoWonder successfully installed, if you have any qeastion, please let us <a href="mailto:wowondersocial@gmail.com">know</a></h5>
                                    <br>
